...
from editor import VideoFileClip, TextClip, CompositeVideoClip, concatenate_videoclips
from moviepy.audio.io.AudioFileClip import AudioFileClip
from moviepy.audio.CompositeAudioClip import CompositeAudioClip
from moviepy.editor import ImageClip  # only ImageClip from moviepy
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # allow your frontend domains here in prod
